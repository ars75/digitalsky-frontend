...
// Site menu Toggle
$(".site-nav").click(function(e){$(this).toggleClass("open"),$(".user-nav.dashboard").removeClass("open"),$(".user-nav.dashboard").hasClass("open")||$(".site-nav").hasClass("open")?$(".site-header").addClass("menu-open"):$(".site-header").removeClass("menu-open")}),$(".user-nav.dashboard").click(function(e){$(this).toggleClass("open"),$(".site-nav").removeClass("open"),$(".user-nav.dashboard").hasClass("open")||$(".site-nav").hasClass("open")?$(".site-header").addClass("menu-open"):$(".site-header").removeClass("menu-open")}),
// Show Apply step
$(".show-apply-step").click(function(e){$(".apply-step").addClass("show")}),
// Sticky navigation after scroll
$(window).scroll(function(){550<$(window).scrollTop()&&$(".site-header").addClass("sticky"),$(window).scrollTop()<551&&$(".site-header").removeClass("sticky")}),
// Clone feilds
